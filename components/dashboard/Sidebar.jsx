  ...
  <div className="bg-neutral-950 h-full p-6">
    ...
    <ul className="text-white text-lg list-none space-y-4 ">
      <Link href="/board?view=overview">
        <li className="transition duration-300 flex items-center p-2 hover:bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 hover:bg-clip-text hover:text-transparent">
