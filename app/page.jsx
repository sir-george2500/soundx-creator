const Home = () => {
  return (
   <section className="w-full flex-center flex-col">
    ...
    Welcome to SoundX Creator Studio: Unleash Your Music, 
    Share Your Story, and Earn from Your Work. Join our artist community 
    and safeguard your digital content.
